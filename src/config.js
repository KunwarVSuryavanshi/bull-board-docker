...
const config = {
	...
	BOARD_TITLE: process.env.BOARD_TITLE,
	BOARD_LOGO: process.env.BOARD_LOGO,
	BOARD_WIDTH: process.env.BOARD_WIDTH,
	BOARD_HEIGHT: process.env.BOARD_HEIGHT,
	FAVICON_DEFAULT: process.env.FAVICON_DEFAULT,
	FAVICON_ALTERNATIVE: process.env.FAVICON_ALTERNATIVE,
